...
class PeopleViewController: UIViewController, PeopleDisplayLogic {
    ...
    override func viewDidLoad() {
        ...
        interactor?.makeRequest(request: .setUsersListener(users: users))
    }
    
    @objc private func signOut() {
        router?.showAlert(title: nil, message: "Are you sure you want to sign out?", type: .signOut)
    }
...
extension PeopleViewController {
    ...
    private func createDataSource() {
        dataSource = UICollectionViewDiffableDataSource<Section, MUser>(collectionView: collectionView, cellProvider: {
