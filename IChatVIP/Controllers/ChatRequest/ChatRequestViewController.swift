...
protocol ChatRequestDisplayLogic: class {
    func displayData(viewModel: ChatRequest.Model.ViewModel.ViewModelData)
}

class ChatRequestViewController: UIViewController, ChatRequestDisplayLogic {
    
    // MARK: - External vars
    
    var interactor: ChatRequestBusinessLogic?
    var router: (NSObjectProtocol & ChatRequestRoutingLogic & ChatRequestDataPassing)?
    ...
    private func setup() {
        ...
        let presenter             = ChatRequestPresenter()
